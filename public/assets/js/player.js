/*
    ...
    */
    ...
    console.dir(playlist.dataset.playdata)

    
    // urls des fichiers audio
    const tbPlaylist = playlist.dataset.playdata 
    ...
    */
    ...
    function displayTime() {
        ...
        setInterval(() => {
            ...
            document.querySelector("#time").innerHTML = formatTime(audioObj.currentTime) +
                " / " +
    ...
    function displayCover() {
        document.querySelector("#cover img").src = urlImgCover + tbPlaylist[currentTrack].cover;
    }
